    ...
    <form wire:submit="login">
        ...
        <div class="text-center mt-4">
            <p class="text-sm text-gray-600">
                ...
                <a href="{{ route('register') }}" class="font-medium text-indigo-600 hover:text-indigo-500 underline rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" wire:navigate>
                    {{ __('Register') }}
                </a>
            </p>
        </div>
